		...
		<div class="col">
			<div class="card ">
				<div class="card-body ">
					...
					<div id="map" class="map" style="width:97%; margin-left:auto;margin-right:auto"></div>F
					...
					<script type="text/javascript">
						...
						map.on('click', function(evt) {
							...
							if (feature) {
								...
								var content = '<h6>' + feature.get('Nama') + '</h6>';

								content += '<p>Alamat: Jl. ' + feature.get('Jalan') + ', Kec. ' + feature.get('Kecamatan') + '</p>';
								content += '<p>Spec PC: ' + feature.get('Spec') + '<br>' + 'Rating: ' + feature.get('Rating') + '<br>' +
									'Suasana: ' + feature.get('Kondisi') + '<br>' + 'Koordinat: ' + feature.get('x') + ', ' +
									feature.get('Y') + '</p>';
								content += '<img src="' + feature.get('Foto') + '" height="200"/>';
